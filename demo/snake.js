...
var _jonalu$elm_snake$Direction$Left = {ctor: 'Left'};
var _jonalu$elm_snake$Direction$Down = {ctor: 'Down'};
...
var _jonalu$elm_snake$Food$randomColor = A4(
	...
	A2(_elm_lang$core$Random$int, 100, 255),
	A2(_elm_lang$core$Random$int, 0, 255),
	A2(_elm_lang$core$Random$int, 0, 255));
var _jonalu$elm_snake$Food$init = {
	position: A2(_jonalu$elm_snake$Position$Position, 0.0, 70.0),
	color: _elm_lang$core$Color$orange
};
var _jonalu$elm_snake$Food$Food = F2(
	function (a, b) {
				...
				return {
					...
					_1: {
						...
						_1: A2(
							...
							_elm_lang$core$List$length(snake.tail) - 1,
							snake.tail)
					}
				};
			} else {
...
var _jonalu$elm_snake$Key$Unknown = {ctor: 'Unknown'};
var _jonalu$elm_snake$Key$Space = {ctor: 'Space'};
var _jonalu$elm_snake$Key$ArrowLeft = {ctor: 'ArrowLeft'};
var _jonalu$elm_snake$Key$ArrowDown = {ctor: 'ArrowDown'};
var _jonalu$elm_snake$Key$ArrowRight = {ctor: 'ArrowRight'};
var _jonalu$elm_snake$Key$ArrowUp = {ctor: 'ArrowUp'};
var _jonalu$elm_snake$Key$fromKeyCode = function (keyCode) {
	var _p0 = keyCode;
	switch (_p0) {
		case 32:
			return _jonalu$elm_snake$Key$Space;
		case 37:
			return _jonalu$elm_snake$Key$ArrowLeft;
		case 38:
			return _jonalu$elm_snake$Key$ArrowUp;
		case 39:
			return _jonalu$elm_snake$Key$ArrowRight;
		case 40:
			return _jonalu$elm_snake$Key$ArrowDown;
		default:
			return _jonalu$elm_snake$Key$Unknown;
	}
};

var _jonalu$elm_snake$MainView$gameStatusText = F2(
	function (msg, textColor) {
...
var _jonalu$elm_snake$MainView$view = function (game) {
	var content = function () {
		...
		if (_p0.ctor === 'NotStarted') {
			...
			var food = A2(
				...
				_jonalu$elm_snake$Position$toFloatTuple(game.food.position),
				A2(
					_evancz$elm_graphics$Collage$filled,
					game.food.color,
					_evancz$elm_graphics$Collage$square(_jonalu$elm_snake$GameSettings$segmentSize)));
			var tail = A2(
				_elm_lang$core$List$map,
				function (position) {
					return A2(
						_evancz$elm_graphics$Collage$move,
						_jonalu$elm_snake$Position$toFloatTuple(position),
						A2(
							_evancz$elm_graphics$Collage$filled,
							game.snake.color,
							_evancz$elm_graphics$Collage$square(_jonalu$elm_snake$GameSettings$segmentSize)));
			...
			var head = A2(
				_evancz$elm_graphics$Collage$move,
				_jonalu$elm_snake$Position$toFloatTuple(game.snake.head),
				A2(
					_evancz$elm_graphics$Collage$filled,
					_elm_lang$core$Color$white,
					_evancz$elm_graphics$Collage$square(_jonalu$elm_snake$GameSettings$segmentSize)));
			var pausedText = function () {
				var _p1 = game.status;
				if (_p1.ctor === 'Paused') {
					return A2(_jonalu$elm_snake$MainView$gameStatusText, 'Paused', _elm_lang$core$Color$white);
				} else {
					return A2(
						_jonalu$elm_snake$MainView$gameStatusText,
						_elm_lang$core$Basics$toString(game.points),
	...
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			_jonalu$elm_snake$GameSettings$gameBoardSize,
			_jonalu$elm_snake$GameSettings$gameBoardSize,
			{ctor: '::', _0: background, _1: content}));
};

var _jonalu$elm_snake$SnakeGame$handleKeyDown = F2(
	function (keyCode, game) {
		var _p0 = game.status;
		switch (_p0.ctor) {
			case 'NotStarted':
				var _p1 = _jonalu$elm_snake$Key$fromKeyCode(keyCode);
				if (_p1.ctor === 'Space') {
					var newGame = _jonalu$elm_snake$Game$init;
					return _elm_lang$core$Native_Utils.update(
						newGame,
						{status: _jonalu$elm_snake$GameStatus$Started});
				} else {
					return game;
				}
			case 'Paused':
				return _elm_lang$core$Native_Utils.update(
					...
					{status: _jonalu$elm_snake$GameStatus$Started});
			default:
				var _p2 = _jonalu$elm_snake$Key$fromKeyCode(keyCode);
				switch (_p2.ctor) {
					case 'ArrowUp':
						return _elm_lang$core$Native_Utils.update(
							game,
							{
								snake: A2(_jonalu$elm_snake$Snake$updateDirection, _jonalu$elm_snake$Direction$Up, game.snake)
							});
					case 'ArrowRight':
						return _elm_lang$core$Native_Utils.update(
							game,
							{
								snake: A2(_jonalu$elm_snake$Snake$updateDirection, _jonalu$elm_snake$Direction$Right, game.snake)
							});
					case 'ArrowDown':
						return _elm_lang$core$Native_Utils.update(
							game,
							{
								snake: A2(_jonalu$elm_snake$Snake$updateDirection, _jonalu$elm_snake$Direction$Down, game.snake)
							});
					case 'ArrowLeft':
						return _elm_lang$core$Native_Utils.update(
							game,
							{
								snake: A2(_jonalu$elm_snake$Snake$updateDirection, _jonalu$elm_snake$Direction$Left, game.snake)
							});
					case 'Space':
						return _elm_lang$core$Native_Utils.update(
							game,
							{status: _jonalu$elm_snake$GameStatus$Paused});
					default:
						return game;
				}
		}
	});
var _jonalu$elm_snake$SnakeGame$handleNewFood = F2(
	function (game, food) {
		return _elm_lang$core$Native_Utils.update(
			game,
			{food: food});
	});
var _jonalu$elm_snake$SnakeGame$init = {ctor: '_Tuple2', _0: _jonalu$elm_snake$Game$init, _1: _elm_lang$core$Platform_Cmd$none};
var _jonalu$elm_snake$SnakeGame$NewFood = function (a) {
...
var _jonalu$elm_snake$SnakeGame$handleTick = function (game) {
	...
	var gameStatus = function () {
		var _p5 = collision;
		if (_p5 === true) {
			return _jonalu$elm_snake$GameStatus$NotStarted;
		} else {
			return game.status;
		}
	}();
	...
	return {
		...
		_0: _elm_lang$core$Native_Utils.update(
			game,
			{snake: newSnake, status: gameStatus, points: points}),
		_1: msg
	};
};
var _jonalu$elm_snake$SnakeGame$updateGame = F2(
	function (msg, game) {
		var _p6 = game.status;
		switch (_p6.ctor) {
			case 'NotStarted':
				...
				if (_p7.ctor === 'KeyDown') {
					return {
						ctor: '_Tuple2',
						_0: A2(_jonalu$elm_snake$SnakeGame$handleKeyDown, _p7._0, game),
			...
			case 'Paused':
				...
				if (_p8.ctor === 'KeyDown') {
					return {
						ctor: '_Tuple2',
						_0: A2(_jonalu$elm_snake$SnakeGame$handleKeyDown, _p8._0, game),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: game, _1: _elm_lang$core$Platform_Cmd$none};
			...
			default:
				...
				switch (_p9.ctor) {
					case 'KeyDown':
						return {
							ctor: '_Tuple2',
							_0: A2(_jonalu$elm_snake$SnakeGame$handleKeyDown, _p9._0, game),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'Tick':
						return _jonalu$elm_snake$SnakeGame$handleTick(game);
					default:
						return {
							ctor: '_Tuple2',
							_0: A2(_jonalu$elm_snake$SnakeGame$handleNewFood, game, _p9._0),
							_1: _elm_lang$core$Platform_Cmd$none
						};
				}
		}
	});
var _jonalu$elm_snake$SnakeGame$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _jonalu$elm_snake$SnakeGame$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _jonalu$elm_snake$SnakeGame$subscriptions = function (game) {
	var _p10 = game.status;
	if (_p10.ctor === 'NotStarted') {
		return _elm_lang$keyboard$Keyboard$downs(_jonalu$elm_snake$SnakeGame$KeyDown);
	} else {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_jonalu$elm_snake$SnakeGame$KeyDown),
				_1: {
					ctor: '::',
					_0: _elm_lang$animation_frame$AnimationFrame$diffs(_jonalu$elm_snake$SnakeGame$Tick),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _jonalu$elm_snake$SnakeGame$main = _elm_lang$html$Html$program(
	{init: _jonalu$elm_snake$SnakeGame$init, view: _jonalu$elm_snake$MainView$view, update: _jonalu$elm_snake$SnakeGame$updateGame, subscriptions: _jonalu$elm_snake$SnakeGame$subscriptions})();

var Elm = {};
Elm['SnakeGame'] = Elm['SnakeGame'] || {};
if (typeof _jonalu$elm_snake$SnakeGame$main !== 'undefined') {
    _jonalu$elm_snake$SnakeGame$main(Elm['SnakeGame'], 'SnakeGame', undefined);
}
